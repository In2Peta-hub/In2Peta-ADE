...
This guide is for people who want to use more than one Codex account in In2Peta ADE.
...
In In2Peta ADE Settings, name it something obvious:
...
In In2Peta ADE Settings, add another Codex provider:
...
In2Peta ADE shows the authenticated email for providers that report one. Emails are blurred by default;
...
If you add a third Codex provider with a completely different `CODEX_HOME path`, In2Peta ADE treats it
