...
export function makeDevelopmentLauncherScript({
  ...
  const envEntries = [
    ...
    ["IN2PETAADE_PORT", environment.IN2PETAADE_PORT ?? environment.T3CODE_PORT],
    ["IN2PETAADE_HOME", environment.IN2PETAADE_HOME ?? environment.T3CODE_HOME],
    [
      "IN2PETAADE_COMMIT_HASH",
      environment.IN2PETAADE_COMMIT_HASH ?? environment.T3CODE_COMMIT_HASH,
    ],
    [
      "IN2PETAADE_OTLP_TRACES_URL",
      environment.IN2PETAADE_OTLP_TRACES_URL ?? environment.T3CODE_OTLP_TRACES_URL,
    ],
    [
      "IN2PETAADE_OTLP_EXPORT_INTERVAL_MS",
      environment.IN2PETAADE_OTLP_EXPORT_INTERVAL_MS ?? environment.T3CODE_OTLP_EXPORT_INTERVAL_MS,
    ],
