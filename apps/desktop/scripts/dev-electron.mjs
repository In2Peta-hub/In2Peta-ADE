...
const remoteDebuggingPort = process.env.IN2PETAADE_DESKTOP_REMOTE_DEBUGGING_PORT?.trim();
...
if (devProtocolClient) {
  childEnv.IN2PETAADE_DESKTOP_APP_USER_MODEL_ID = devProtocolClient.appBundleId;
  childEnv.IN2PETAADE_DESKTOP_PROTOCOL_REGISTRATION_MANAGED = "1";
}
