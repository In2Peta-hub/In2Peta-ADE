...
declare const __IN2PETAADE_BUILD_CLERK_PUBLISHABLE_KEY__: string | undefined;
...
function configuredClerkFrontendApiHostname(): string | null {
  const publishableKey =
    process.env.IN2PETAADE_CLERK_PUBLISHABLE_KEY?.trim() ||
    (typeof __IN2PETAADE_BUILD_CLERK_PUBLISHABLE_KEY__ === "undefined"
      ? ""
      : __IN2PETAADE_BUILD_CLERK_PUBLISHABLE_KEY__.trim());
