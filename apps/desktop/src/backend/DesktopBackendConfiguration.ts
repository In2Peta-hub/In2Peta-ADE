...
const DESKTOP_BACKEND_ENV_NAMES = [
  "IN2PETAADE_PORT",
  "IN2PETAADE_MODE",
  "IN2PETAADE_NO_BROWSER",
  "IN2PETAADE_HOST",
  "IN2PETAADE_DESKTOP_WS_URL",
  "IN2PETAADE_DESKTOP_LAN_ACCESS",
  "IN2PETAADE_DESKTOP_LAN_HOST",
  "IN2PETAADE_DESKTOP_HTTPS_ENDPOINTS",
  "IN2PETAADE_TAILSCALE_SERVE",
  "IN2PETAADE_TAILSCALE_SERVE_PORT",
] as const;
