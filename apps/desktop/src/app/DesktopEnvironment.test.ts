...
const defaultInput = {
  ...
  processArch: "arm64",
  appVersion: "0.0.22",
  appPath: "/Applications/In2Peta ADE.app/Contents/Resources/app.asar",
  isPackaged: false,
  resourcesPath: "/Applications/In2Peta ADE.app/Contents/Resources",
  ...
  it.effect("derives state paths and development identity inside Effect", () =>
    Effect.gen(function* () {
      const environment = yield* makeEnvironment(
        {},
        {
          IN2PETAADE_HOME: " /tmp/t3 ",
          IN2PETAADE_COMMIT_HASH: " 0123456789abcdef ",
          IN2PETAADE_PORT: "4949",
          VITE_DEV_SERVER_URL: "http://localhost:5173",
          IN2PETAADE_DEV_REMOTE_T3_SERVER_ENTRY_PATH: " /remote/server.mjs ",
          IN2PETAADE_OTLP_TRACES_URL: " http://127.0.0.1:4318/v1/traces ",
          IN2PETAADE_OTLP_EXPORT_INTERVAL_MS: "2500",
        },
      );
  ...
  it.effect("uses a configured app user model id override", () =>
    Effect.gen(function* () {
      const environment = yield* makeEnvironment(
        {},
        {
          IN2PETAADE_DESKTOP_APP_USER_MODEL_ID: " com.t3tools.t3code.dev.local ",
          VITE_DEV_SERVER_URL: "http://localhost:5173",
        },
      );
