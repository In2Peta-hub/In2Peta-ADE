    ...
    yield* Effect.acquireUseRelease(
      ...
      Effect.fn("captureCheckpoint.withTempDirectory")(function* (tempDir) {
        ...
        const commitEnv: NodeJS.ProcessEnv = {
          ...
          GIT_AUTHOR_NAME: "In2Peta ADE",
          GIT_AUTHOR_EMAIL: "in2petaade@users.noreply.github.com",
          GIT_COMMITTER_NAME: "In2Peta ADE",
          GIT_COMMITTER_EMAIL: "in2petaade@users.noreply.github.com",
        };
