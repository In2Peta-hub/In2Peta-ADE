...
export const CLIENT_SETTINGS_STORAGE_KEY = "in2petaade:client-settings:v1";
export const SAVED_ENVIRONMENT_REGISTRY_STORAGE_KEY = "in2petaade:saved-environment-registry:v1";
