...
export const PERSISTED_STATE_KEY = "in2petaade:ui-state:v1";
const LEGACY_PERSISTED_STATE_KEYS = [
  "in2petaade:renderer-state:v8",
  "in2petaade:renderer-state:v7",
  "in2petaade:renderer-state:v6",
  "in2petaade:renderer-state:v5",
  "in2petaade:renderer-state:v4",
  "in2petaade:renderer-state:v3",
