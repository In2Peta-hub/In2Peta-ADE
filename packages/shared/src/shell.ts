...
const PATH_CAPTURE_START = "__IN2PETAADE_PATH_START__";
const PATH_CAPTURE_END = "__IN2PETAADE_PATH_END__";
...
function envCaptureStart(name: string): string {
  return `__IN2PETAADE_ENV_${name}_START__`;
}

function envCaptureEnd(name: string): string {
  return `__IN2PETAADE_ENV_${name}_END__`;
}
